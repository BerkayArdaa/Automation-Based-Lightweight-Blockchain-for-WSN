...
<simconf version="2023090101">
  <simulation>
    ...
    <motetype>
      org.contikios.cooja.contikimote.ContikiMoteType
      <description>Atackker</description>
      <source>[CONFIG_DIR]/attacker.c</source>
      <commands>$(MAKE) -j$(CPUS) attacker.cooja TARGET=cooja</commands>
      <moteinterface>org.contikios.cooja.interfaces.Position</moteinterface>
      <moteinterface>org.contikios.cooja.interfaces.Battery</moteinterface>
      <moteinterface>org.contikios.cooja.contikimote.interfaces.ContikiVib</moteinterface>
      <moteinterface>org.contikios.cooja.contikimote.interfaces.ContikiMoteID</moteinterface>
      ...
      <mote>
        <interface_config>
          org.contikios.cooja.interfaces.Position
          <pos x="84.8177019827979" y="33.444486341720115" />
        </interface_config>
        <interface_config>
          org.contikios.cooja.contikimote.interfaces.ContikiMoteID
          <id>19</id>
    ...
    <motetype>
      org.contikios.cooja.contikimote.ContikiMoteType
      <description>Attacker2</description>
      <source>[CONFIG_DIR]/attacker.c</source>
      <commands>$(MAKE) -j$(CPUS) attacker.cooja TARGET=cooja</commands>
      <moteinterface>org.contikios.cooja.interfaces.Position</moteinterface>
      <moteinterface>org.contikios.cooja.interfaces.Battery</moteinterface>
      ...
      <mote>
        <interface_config>
          org.contikios.cooja.interfaces.Position
          <pos x="77.5664929124433" y="55.836086264021596" />
        </interface_config>
        <interface_config>
          org.contikios.cooja.contikimote.interfaces.ContikiMoteID
          <id>18</id>
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>5.259892303849654 0.0 0.0 5.259892303849654 29.959910248269463 -58.648123687889374</viewport>
    </plugin_config>
    <bounds x="1820" y="806" height="511" width="655" />
  </plugin>
  <plugin>
    ...
    <bounds x="400" y="160" height="938" width="1948" z="1" />
  </plugin>
  <plugin>
    ...
    <bounds x="0" y="1279" height="166" width="2348" z="6" />
  </plugin>
  <plugin>
    ...
    <bounds x="400" y="0" height="160" width="1948" z="5" />
  </plugin>
  <plugin>
  ...
  <plugin>
    ...
    <bounds x="1026" y="344" height="300" width="350" z="3" />
  </plugin>
  <plugin>
    org.contikios.cooja.plugins.MoteInformation
    <mote_arg>17</mote_arg>
    <bounds x="0" y="0" height="155" width="383" z="2" />
  </plugin>
</simconf>
